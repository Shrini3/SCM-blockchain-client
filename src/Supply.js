...
function Supply() {
    ...
    const loadBlockchaindata = async () => {
        ...
        //console.log(account) -> displays current account
    ...
    const handleSubmitTransport = async (event) => {
        event.preventDefault()
        try {
    ...
    return (
        <div className="supply-container">
            ...
            <div className="supply-step">
                <h5><b>Step 1: Transport Matrials:</b> (Only a registered Transporter can perform this step):</h5>
                <form onSubmit={handleSubmitTransport}>
                    <input className="form-control-sm" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                    <button className="btn btn-outline-success btn-sm">Transport</button>
                </form>
            </div>
            <hr />
            <div className="supply-step">
