        ...
        <div style={styles.container}>
            <div style={styles.content}>
                ...
                <div style={styles.buttonGroup}>
                    ...
                    {/* <button onClick={() => redirectTo('/supply')} style={styles.button}>Add Stock</button> */}
                    ...
                    <button onClick={() => redirectTo('/generateqr')} style={styles.button}>Generate QR</button>
                    <button onClick={() => redirectTo('/scanqr')} style={styles.button}>Scan QR</button>
                </div>
            </div>
        </div>
    );
